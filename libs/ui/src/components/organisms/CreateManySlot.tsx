...
export const CreateManySlotDialog = ({ garageId, displayName }: { garageId: number,displayName: string }) => {
  ...
  return (
    <>
      ...
      <Dialog open={open} setOpen={setOpen} title={'Create Slots - ' + displayName}>
        <Form
