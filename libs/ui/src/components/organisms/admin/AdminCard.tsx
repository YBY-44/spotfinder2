import { AdminsQuery } from "@spotfinder2/network/src/gql/generated";
  ...
  return (
    <div className="bg-white p-2">
      <div className="flex items-center gap-2">
        ...
        {uid === admin.uid ? (
          <span className="px-1 text-xs bg-primary shadow-sm">You</span>
        ) : null}
      </div>
      ...
      <p className="mt-2">
        <span className="text-2xl">{admin.numberOfVerifacation}</span>{" "}
